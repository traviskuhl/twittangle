	...
	<?php
		if ( $this->param('flow') == 'remove' ) {
			echo "
				<div class='module red'><div class='bd'>
					<div class='b'>Account Removed from twitTangle</div>
					We've removed your account from twitTangle. Your profile page should become inactive within the next 12 hours.
					</div>
				</div>
				<br>
			";
	...
	?>
                                ...
                                <div class='module red'><div class='bd'>
<div class='b'>twitTangle is shutting down</div>
On December 24th, 2010, twitTangle will be shutting down. Please contact @twittangle with any questions. Thank you for your support over the past two years!
...
$block = array('hollowmarketing','le198','maximedt');
		
					foreach ( $cache['results'] as $item ) {
						if ( !in_array(strtolower($item['from_user']),$block) AND  strtolower($item['from_user']) != 'twittangle' AND stripos($item['text'],"@twittangle remove") === false ) {
							$r[] = array(
								'text' => $item['text'],
								'id' => $item['id'],					
