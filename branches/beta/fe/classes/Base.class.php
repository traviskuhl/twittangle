	...
	class Base extends Config {
		...
		public function dispatch() {
			...
			ob_clean();
				...
				if ( is_array($this->customProfile) AND strpos($this->customProfile['profile_background_image_url'],'s.twimg.com') === false ) {
							...
							switch($key) {									
								case 'profile_background_image_url':
									$this->profileCss .= " 
										...
										body #doc4 #hd { margin-bottom: 0; }										 
										body #doc4 #bd { background: #fff; padding-top: 30px; }
										body #doc4 #hd a.logo { 
