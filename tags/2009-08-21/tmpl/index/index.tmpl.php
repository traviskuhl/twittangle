 ...
 <div class="gray small">If you'd still like to use the normal login, enter your username and password below. We <strong class="b">strongly</strong> suggest using the link above</div>
						...
						<ul class='form'>				
							...
							<li>
								...
								<button type="submit" onclick=" this.innerHTML='Wait...'; return true; this.disabled=true; ">Login</button>
							</li>
						</ul>
						...
						<br>
						<?php /* <div class='center small' style='color:red'>Due to a Twitter's recent <a href='http://status.twitter.com' style='color:red'>DoS attack</a> they Some sections of twitTangle.com may not function<br>correctly as a result of Twitter API issues.</strong></div> 						*/ ?>
