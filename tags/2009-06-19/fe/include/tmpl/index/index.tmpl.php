	...
	<div class='yui-g'>
		...
		<div class='yui-u second'>
			...
			?>
				...
				<p>Use your <a href='http://twitter.com'>Twitter</a> account to login. Don't have a Twitter account... <a href='https://twitter.com/signup'>get one now</a></p>
				<ul class='form'>				
					<li>
						<label>
							<em>Username or Email Address</em>
					...
					<li>
						<label>
							<em>Remember Me</em>
							<input type="checkbox" name="r" value='1' checked="checked">
						</label>
					</li>
					<li>			
				...
				<div class="hide" style='color:red'>Twitter is reporting intermittent 
								capacity issues. This may limit your ability to use twitTangle</div> 
...
<h3>What they're are saying about <a target='_new' href='http://twitter.com/twitTangle'>@twitTangle</a></h3>
