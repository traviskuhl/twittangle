...
<div class="yui-ge">
	...
	<div class="yui-u side">
		...
		?>
			...
			<div class="module">
				<div class="bd center">
					<div class="b"><a href="<?php echo $this->url('networks'); ?>">Start a Network</a></div>
					<div class="small gray">Try out the all new networks section &amp; create or join a network for your favorite hobby</div>
				</div>
			</div>
			<br>	
					...
					<ul>
						<?php	error_reporting(E_ALL);
							foreach ( $groups as $g ) {
								...
								// get last 
								$l = $this->param($lkey,time(),$this->lastCookies);
